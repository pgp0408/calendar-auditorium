document.addEventListener("DOMContentLoaded", function () {
  ...
  const DETAIL_MOMENTS = [
    { key: "journee", label: "Journée entière / fil rouge" },
    { key: "matin", label: "Matin" },
    { key: "apresmidi", label: "Après-midi" },
    { key: "soir", label: "Soirée" }
  ];
  ...
  root.innerHTML = `
    <style>
      ...
      #semainejps-calendar .jps-event.permanent{
    ...
    <div class="jps-card">
      <div class="jps-header">
        <div class="jps-header-grid">
          <div>
            ...
            <p class="jps-sub">
              ...
              Les journées sont explorables en priorité, puis les frises permettent de vérifier les temps scolaires et les temps tout public.
            </p>
          </div>
        ...
        <div class="jps-legend">
          ...
          <span class="jps-pill"><span class="jps-dot permanent"></span>Fil rouge / journée entière</span>
        </div>
      </div>
        ...
        <section class="jps-section">
          <div class="jps-titlebar">
            <div>
              ...
              <p>Vue prioritaire : chaque bouton ouvre le détail complet de la journée, y compris le soir.</p>
            </div>
        ...
        <section class="jps-section">
          <div class="jps-titlebar">
            <div>
              ...
              <p>Lundi, mardi, jeudi et vendredi : uniquement 08h30–12h00 et 13h00–17h00. Cliquez sur un jour pour voir toute la journée.</p>
            </div>
        ...
        <section class="jps-section">
          <div class="jps-titlebar">
            <div>
              ...
              <p>Lecture synthétique des journées tout public. Cliquez sur un jour pour voir l’ensemble des propositions.</p>
            </div>
  ...
  function renderEvent(ev){
    ...
    btn.type = "button";
    btn.className = "jps-event " + ev.statusKind + (isPermanentExpo(ev) ? " permanent" : "");
  ...
  function openDayModal(dayIso){
    ...
    $("jps-day-modal-sub").textContent =
      dayEvents.length + " proposition(s) affichée(s), dont " +
      dayEvents.filter(isRealProgramming).length + " hors fil rouge.";

    const detail = $("jps-day-detail");
    detail.innerHTML = "";

    DETAIL_MOMENTS.forEach(moment => {
