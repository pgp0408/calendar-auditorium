document.addEventListener("DOMContentLoaded", function () {
  ...
  function bindAddButtons() {
    root.querySelectorAll("[data-add-slot-id]").forEach(b => b.addEventListener("click", function () { const s = allSlots.find(x => x.id === b.getAttribute("data-add-slot-id")); if (s && !s.full && cartFor(s.id) < s.remaining) openBooking(s); }));
  }
