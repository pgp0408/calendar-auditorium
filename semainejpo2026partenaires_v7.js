  ...
  root.innerHTML = `
    ...
    <div class="wrap">
      <header class="head">
        ...
        <div class="intro"><strong>Logique retenue :</strong> auditorium affiché systématiquement ; autres créneaux affichés uniquement lorsque le cumul des réservations confirmées atteint au moins ${AFFLUENCE_THRESHOLD} personnes sur le même horaire.</div>
      </header>
      <main class="content">
