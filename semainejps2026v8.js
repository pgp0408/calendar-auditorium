document.addEventListener("DOMContentLoaded", function () {
        ...
        <div class="jps-header-grid">
          <div>
            ...
            <p class="jps-sub">
              ...
              Les frises distinguent désormais le temps scolaire réel : lundi, mardi, jeudi et vendredi, de 08h30 à 12h00 puis de 13h00 à 17h00.
            </p>
          </div>
  ...
  function slotSummary(dayIso, momentKey, data){
    ...
    if(momentKey === "matin" || momentKey === "apresmidi"){
      const schoolRelevantEvents = realEvents.filter(isSchoolTime);

      if(isSchoolDay(dayIso)){
  ...
  function renderDayButtons(data){
    ...
    DAYS.forEach(day => {
      ...
      const warningText = realEvents.length
        ? realEvents.length + " proposition(s) hors fil rouge"
        : "À combler hors expo permanente";
