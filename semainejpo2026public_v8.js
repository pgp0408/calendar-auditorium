  ...
  root.innerHTML = `
    ...
    <div class="wrap">
      <header class="head">
        ...
        <div class="intro"><strong>Bienvenue au Conservatoire.</strong><br>Les rendez-vous ouverts au grand public sont proposés les lundi, mardi, jeudi et vendredi à partir de 17h30 et jusqu’à 20h, le mercredi tout au long de la journée, le samedi jusqu’à 16h, puis le dimanche de 16h à 20h à l’occasion de la Fête de la musique. Cette page vous permet d’identifier simplement les moments accessibles aux familles, futurs élèves, curieux et amateurs de musique, de danse ou de théâtre.</div>
        <div class="freebox">Accès libre et gratuit, dans la limite des places disponibles. Aucune réservation n’est possible depuis cette page. Pour plus d’informations : <strong>communication@crd.corsica</strong> — <strong>06.67.57.92.65</strong>.</div>
      </header>
      <main class="content">
