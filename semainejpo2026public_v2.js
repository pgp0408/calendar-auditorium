document.addEventListener("DOMContentLoaded", function () {
  ...
  function isHighlight(slot) {
    return slot.roomKey === "auditorium" || (LARGE_ROOM_KEYS.includes(slot.roomKey) && Number(slot.capacity || 0) >= 35);
  }
  ...
  function renderFocus(slots) {
    ...
    $("jpo-public-focus-section").innerHTML = '<div class="focus-head"><div><div class="focus-title">Temps forts de la semaine</div><div class="focus-sub">Les propositions à l’auditorium ou dans les grandes salles sont mises en avant automatiquement.</div></div><div class="badge">' + highlights.length + ' sélection</div></div><div class="focus-body"><div class="cards">' + highlights.map(renderCard).join("") + '</div></div>';
  }
