document.addEventListener("DOMContentLoaded", function () {
  ...
  const ROOMS = [
    ...
    { key: "choeur", short: "Chœur", label: "Salle de chœur", capacity: "40 places" },
    { key: "theatre", short: "Théâtre", label: "Salle de théâtre", capacity: "40 places" },
    { key: "danse1", short: "Danse 1", label: "Studio de danse 1", capacity: "40 places" },
    { key: "danse2", short: "Danse 2", label: "Studio de danse 2", capacity: "40 places" },
    { key: "danse3", short: "Danse 3", label: "Studio de danse 3", capacity: "40 places" },
    { key: "other", short: "Autre", label: "Autre salle / autre lieu", capacity: "à préciser" },
    { key: "any", short: "À arbitrer", label: "À arbitrer", capacity: "à affecter" }
  ];
      ...
      <div class="jps-header">
        <div class="jps-header-grid">
          <div>
            ...
            <p class="jps-sub">V15 — version interne propre avec arbitrage CRD des salles, capacités, pôles et formats bloqués.</p>
          </div>
  ...
  function roomInfo(v, precision){
    ...
    if(s.includes("autre") || p){
      return {
        key:"other",
        short:p ? p : "Autre",
        label:p ? p : "Autre salle / autre lieu",
        capacity:"à préciser",
        capacityNum:40
      };
    }
    ...
    return {key:"other",short:v || "Autre",label:v || "Autre salle / autre lieu",capacity:"à préciser",capacityNum:40};
  }
