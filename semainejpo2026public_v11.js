document.addEventListener("DOMContentLoaded", function () {
  ...
  root.innerHTML = `
    ...
    <div class="wrap">
      <header class="head">
        ...
        <p class="sub">Du 15 au 21 juin 2026, le Conservatoire Henri Tomasi ouvre ses portes aux familles, futurs élèves et curieux, avec des rendez-vous accessibles tout au long de la semaine.</p>
        <div class="intro"><strong>Bienvenue au Conservatoire.</strong><br>Cette page rassemble les propositions accessibles au grand public : concerts, auditions, ateliers ouverts, démonstrations, rencontres avec les enseignants et temps de découverte. L’accueil du public est particulièrement prévu le lundi, mardi, jeudi et vendredi <strong>à partir de 17h</strong>, le mercredi toute la journée, le samedi jusqu’à 16h, puis le dimanche de 16h à 20h autour de la Fête de la musique. Venez découvrir les disciplines, visiter les espaces, poser vos questions et préparer une éventuelle inscription.</div>
        <div class="freebox">Accès libre et gratuit, dans la limite des places disponibles. Aucune réservation n’est possible depuis cette page.<br><strong>Pour plus d’informations :</strong> communication@crd.corsica · 06.67.57.92.65</div>
      </header>
      <main class="content">
  ...
  function renderFocus(slots) {
    ...
    const highlights = slots.filter(isHighlight).filter(slot => {
