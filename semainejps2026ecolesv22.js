document.addEventListener("DOMContentLoaded", function () {
  ...
  const STORAGE_KEY = "jps_ecoles_v22_panier";
  const LAST_GROUP_KEY = "jps_ecoles_v22_last_group";
  ...
  function render() {
    ...
    $("jps-days").innerHTML =
      '<section class="day">' +
        ...
        '</div>' +
        '<div class="daybody">' +
          '<p class="choice-hint">Mode d’emploi : choisissez un horaire, consultez le détail si besoin, puis ajoutez chaque classe à son parcours. Les suggestions ci-dessus sont indicatives : vous restez libre de composer le parcours.</p>' +
