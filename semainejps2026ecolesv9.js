document.addEventListener("DOMContentLoaded", function () {
  ...
  function bindAddButtons() {
    // V8/V9 : on utilise une délégation de clic globale plus robuste.
    // Les cartes sont recréées à chaque changement de jour / panier ; cette méthode évite les boutons non reliés.
  }
  ...
  root.addEventListener("click", function(e) {
    ...
    if (addBtn) {
      e.preventDefault();
      e.stopPropagation();
      const slotId = addBtn.getAttribute("data-add");
