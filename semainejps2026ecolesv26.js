document.addEventListener("DOMContentLoaded", function () {
  ...
  const STORAGE_KEY = "jps_ecoles_v26_panier";
  const LAST_GROUP_KEY = "jps_ecoles_v26_last_group";
  ...
  function openAutoBuilder(duration) {
  ...
  root.querySelectorAll("[data-suggest-duration]").forEach(button => {
    button.addEventListener("click", function () {
      openAutoBuilder(parseInt(button.getAttribute("data-suggest-duration"), 10));
    });
  });
