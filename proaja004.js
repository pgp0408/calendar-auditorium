document.addEventListener("DOMContentLoaded", function () {
  ...
  root.innerHTML = `
    <style>
      ...
      #proaja-calendar .pc-btn:hover,
      #proaja-calendar .pc-filter:hover {
        background:#f9fafb;
      ...
      #proaja-calendar .pc-dot.auditorium { background:var(--pc-green); }
      #proaja-calendar .pc-dot.orchestre { background:var(--pc-blue); }
      #proaja-calendar .pc-dot.autre { background:var(--pc-purple); }
      #proaja-calendar .pc-dot.pending { background:var(--pc-orange); }
      ...
      #proaja-calendar .pc-event:hover {
        transform:translateY(-1px);
        box-shadow:0 8px 18px rgba(15,23,42,.16);
      }

      #proaja-calendar .pc-event.auditorium { background:var(--pc-green); }
      #proaja-calendar .pc-event.orchestre { background:var(--pc-blue); }
      #proaja-calendar .pc-event.autre { background:var(--pc-purple); }
      ...
      #proaja-calendar .pc-event-title {
        display:block;
        overflow:hidden;
      ...
      #proaja-calendar .pc-item:hover {
        background:#fff;
        transform:translateY(-1px);
        box-shadow:0 10px 24px rgba(15,23,42,.08);
      }

      #proaja-calendar .pc-item.auditorium { border-left-color:var(--pc-green); }
      #proaja-calendar .pc-item.orchestre { border-left-color:var(--pc-blue); }
      #proaja-calendar .pc-item.autre { border-left-color:var(--pc-purple); }
      #proaja-calendar .pc-item.pending { border-left-color:var(--pc-orange); }
      ...
      #proaja-calendar .pc-badge.auditorium { background:var(--pc-green); }
      #proaja-calendar .pc-badge.orchestre { background:var(--pc-blue); }
      #proaja-calendar .pc-badge.autre { background:var(--pc-purple); }
      ...
      @media (max-width:480px) {
        #proaja-calendar .pc-card { border-radius:16px; }
        #proaja-calendar .pc-calendar-panel,
        #proaja-calendar .pc-list-panel {
          padding:12px;
          border-radius:16px;
        }
        #proaja-calendar .pc-day { min-height:78px; }
        #proaja-calendar .pc-btn {
          padding:9px 12px;
          font-size:13px;
        }
  ...
  function statusInfo(v) {
    ...
    if (
      s.includes("projet valide") ||
      s.includes("reservation acceptee") ||
      s.includes("acceptee") ||
      s.includes("accepte") ||
      s.includes("valide")
    ) {
  ...
  function renderCalendar() {
    ...
    for (let i = 0; i < 42; i++) {
      ...
      eventsWrap.className = "pc-events";
