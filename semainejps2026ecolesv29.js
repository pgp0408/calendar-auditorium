document.addEventListener("DOMContentLoaded", function () {
  ...
  const STORAGE_KEY = "jps_ecoles_v29_panier";
  const LAST_GROUP_KEY = "jps_ecoles_v29_last_group";
  ...
  function visibleSlotsForActiveDay() {
    return allSlots.filter(slot => slot.dateIso === activeDay && slotMatchesLevel(slot));
  }
  ...
  $("jps-level-filter").addEventListener("change", render);
