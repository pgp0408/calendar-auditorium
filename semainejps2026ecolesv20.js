document.addEventListener("DOMContentLoaded", function () {
  ...
  const STORAGE_KEY = "jps_ecoles_v20_panier";
  const LAST_GROUP_KEY = "jps_ecoles_v20_last_group";
  ...
  function openBooking(slot) {
    ...
    $("jps-b-group").value = last.group || "";
    $("jps-b-students").value = last.students || "";
    $("jps-b-adults").value = last.adults || "";
    updateBookingHelp();
