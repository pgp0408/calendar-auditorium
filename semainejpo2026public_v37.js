(function () {
  ...
  function renderStats(slots) {
    ...
    const unique = publicUniqueEstimate(slots);
    const peaks = peakMoments(slots, 3);
    const maxPeak = peaks.length ? peaks[0].total : 0;
    $("jpo-public-stats").innerHTML =
      '<div class="stat statgroup"><div class="stat-title">Rendez-vous publics</div><div class="stat-main"><div class="num">' + slots.length + '</div><span>rendez-vous affichés</span></div><div class="mini"><div><b>' + highlights + '</b><span>temps forts</span></div><div><b>' + aud + '</b><span>auditorium</span></div><div><b>' + full + '</b><span>complets</span></div><div><b>' + remaining + '</b><span>places restantes</span></div></div></div>' +
      '<div class="stat statgroup"><div class="stat-title">Réservations et jauges</div><div class="stat-main"><div class="num">' + (publicTaken + schoolTaken) + '</div><span>places déjà bloquées</span></div><div class="mini"><div><b>' + publicTaken + '</b><span>tout public</span></div><div><b>' + unique + '</b><span>individus publics estimés</span></div><div><b>' + schoolTaken + '</b><span>scolaires bloqués</span></div><div><b>180</b><span>jauge auditorium max</span></div></div></div>' +
