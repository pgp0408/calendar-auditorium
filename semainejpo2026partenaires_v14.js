document.addEventListener("DOMContentLoaded", function () {
  ...
  root.innerHTML = `
    ...
    <div class="wrap">
      <header class="head">
        ...
        <p class="sub">Une page de repérage pour identifier les meilleurs moments de venue : propositions avec public à l’auditorium et horaires où plusieurs propositions accueillent du public en même temps dans le Conservatoire, y compris les publics scolaires.</p>
        <div class="intro"><strong>Logique retenue :</strong> les propositions de l’auditorium sont affichées lorsqu’elles accueillent du public réservé ; hors auditorium, un horaire n’est affiché que si plusieurs propositions reçoivent du public en même temps. Le total horaire reste un repère, sans additionner des créneaux qui ne commencent pas exactement à la même heure.</div>
      </header>
      <main class="content">
  ...
  function filtered(){return allSlots.filter(s=>{
    const aud=hasDirectPublic(s)&&hasAuditorium(s), aff=hasDirectPublic(s)&&!hasAuditorium(s)&&isParallelPublicMoment(s);
  ...
  function renderCard(s){
    ...
    return '<article class="card '+(isRepere(s)?'strong':'')+'"><div class="top"><div class="chips">'+
      ...
      (!hasAuditorium(s)&&isParallelPublicMoment(s)?'<span class="chip green">Public en parallèle</span>':'')+
