(function () {
  // V37 : source école conservée, jauge auditorium 180, démarrage robuste WordPress.
  function initJpsEcoles() {
  ...
  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", initJpsEcoles);
  } else {
    initJpsEcoles();
  }
})();
